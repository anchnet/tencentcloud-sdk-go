...
func NewClientWithSecretId(secretId, secretKey string) (client *Client, err error) {
	client = &Client{}
	client.Init("").WithSecretId(secretId, secretKey)
	return
}
...
func NewDescribeResourceBillsRequest() (request *DescribeResourceBillsRequest) {
	request = &DescribeResourceBillsRequest{
		BaseRequest: &tchttp.BaseRequest{},
		Platform:    "qcloud",
		PayType:     "deduct",
	}
	request.Init().WithApiInfo("feecenter", APIVersion, "DescribeResourceBills")
	return
}

func NewDescribeResourceBillsResponse() (response *DescribeResourceBillsResponse) {
	response = &DescribeResourceBillsResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}

func (c *Client) DescribeResourceBills(request *DescribeResourceBillsRequest) (response *DescribeResourceBillsResponse, err error) {
	if request == nil {
		request = NewDescribeResourceBillsRequest()
	}
	response = NewDescribeResourceBillsResponse()
...
func NewDescribeBillsRequest() (request *DescribeBillsRequest) {
	...
	request.Init().WithApiInfo("feecenter", APIVersion, "DescribeBills")
	return
}
