...
func NewDescribeDealsByCond() (request *DescribeDealsByCond) {
...
func (c *Client) DescribeDealsByCond(request *DescribeDealsByCond) (response *DescribeDealsByCondResponse, err error) {
	if request == nil {
		request = NewDescribeDealsByCond()
	}
